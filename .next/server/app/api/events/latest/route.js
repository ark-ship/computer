(()=>{var a={};a.id=301,a.ids=[301],a.modules={261:a=>{"use strict";a.exports=require("next/dist/shared/lib/router/utils/app-paths")},846:a=>{"use strict";a.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},857:(a,b,c)=>{"use strict";c.a(a,async(a,d)=>{try{c.r(b),c.d(b,{GET:()=>h,dynamic:()=>j,runtime:()=>i});var e=c(641),f=c(7143),g=a([f]);f=(g.then?(await g)():g)[0];let i="nodejs",j="force-dynamic";async function h(a){try{let b=a.nextUrl.searchParams.get("wallet")?.trim().toLowerCase(),c=a.nextUrl.searchParams.get("after")?.trim();if(!b)return e.NextResponse.json({ok:!1,error:"Wallet is required."},{status:400,headers:{"Cache-Control":"no-store, no-cache, must-revalidate"}});if(await (0,f.X)(),c){let a=await (0,f.db)(`
        ...
        LIMIT 50
        `,[b,c]);return e.NextResponse.json({ok:!0,events:a},{headers:{"Cache-Control":"no-store, no-cache, must-revalidate"}})}let d=await (0,f.db)(`
      SELECT
        id,
        task_id,
        message,
