...
// Validate ../../app/api/events/latest/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/events/latest">> = Specific
  const handler = {} as typeof import("../../app/api/events/latest/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
...
// Validate ../../app/api/webhooks/alchemy/route.ts
{
  ...
  const handler = {} as typeof import("../../app/api/webhooks/alchemy/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
